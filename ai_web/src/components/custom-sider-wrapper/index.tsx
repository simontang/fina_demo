...
export const CustomSiderWrapper: React.FC<RefineThemedLayoutSiderProps> = (
  ...
  const customMenuItems: MenuItem[] = [
    getItem("Agent Center", "agent-center", <RobotOutlined />, [
      ...
      getItem("Computer Use Agent", "computer-use-agent", <WarningOutlined />),
    ]),
  ...
  const pathMap: Record<string, string> = {
    ...
    "computer-use-agent": "/agents/computer_use_agent",
  ...
  const getSelectedKeys = (): string[] => {
    ...
    const pathToKey: Record<string, string> = {
      ...
      "/admin/agents/computer_use_agent": "computer-use-agent",
