...
table_payload = {
    ...
    "shortDesc": "按销售团队分摊的 Sell-out 明细；默认指标排除极端源值，并保留原始值和质量标记供审计。",
...
metric_specs = [
    {
        ...
        "description": "有效 Sell-out 金额（人民币）：汇总销售团队分摊金额，并默认排除触发质量规则的极端源记录。",
    ...
    },
    {
        ...
        "description": "有效 Sell-out 数量：汇总销售团队分摊数量，并默认排除触发质量规则的极端源记录。",
    ...
    },
    {
        ...
        "description": "因极端数量、极端金额或分摊金额不可解析而被默认指标排除的 Sell-out 分摊金额。",
