...
/**
 * Converts a semantic query request into executable SQL Server SQL.
 *
...
public interface SemanticQueryBuilder {
    ...
    /**
     * Build a SQL Server SQL statement for one metric.
     *
    ...
    /**
     * Build a single SQL Server SQL for multiple metrics (one result set).
