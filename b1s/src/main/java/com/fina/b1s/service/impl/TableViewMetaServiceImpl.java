 ...
 *   3. meta/VW_*.csv      — column list for tables not covered by any view JSON
 *
...
public class TableViewMetaServiceImpl implements TableViewMetaService {
    ...
    private static final String CSV_PATTERN  = "classpath*:meta/VW_*.csv";
    ...
    private void loadCsvOnly(
        ...
        try {
            ...
            log.error("Failed to scan VW_*.csv: {}", e.getMessage());
        }
    }
