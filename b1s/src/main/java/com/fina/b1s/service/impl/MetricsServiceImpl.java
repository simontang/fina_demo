...
import com.fina.b1s.config.DynamicDataSourceManager;
import com.fina.b1s.dto.*;
import com.fina.b1s.entity.MetricsMeta;
import com.fina.b1s.mapper.DataSourceConfigMapper;
import com.fina.b1s.mapper.MetricsMetaMapper;
import com.fina.b1s.service.MetaCatalogService;
import com.fina.b1s.service.MetricsService;
import com.fina.b1s.service.SemanticQueryBuilder;
import com.fina.b1s.service.TableViewMetaService;
...
public class MetricsServiceImpl implements MetricsService {
    ...
    private final ViewTranslationService   viewTranslationService;
    ...
    public MetricsQueryData query(SemanticQueryRequest request) {
        ...
        if (StringUtils.hasText(request.getCustomSql())) {
            ...
            // request.limit is ignored here; the SQL translator normalizes an explicit LIMIT/TOP.
            String sqlToRun = viewTranslationService.translateSql(request.getCustomSql());
        ...
        String sqlToRun = viewTranslationService.translateSql(built.sql());
        QueryResult qr = executeQuery(request.getDatasourceId(), sqlToRun, built.params());
        ...
        if (debug) {
            ...
            debugObj.put("logicalSql", built.sql());
            debugObj.put("sql", sqlToRun);
